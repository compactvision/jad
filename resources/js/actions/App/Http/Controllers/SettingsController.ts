...
/**
* @see \App\Http\Controllers\SettingsController::updateNotifications
...
* @route '/dashboard/settings/notifications'
*/
updateNotificationsForm.patch = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: updateNotifications.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PATCH',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const SettingsController = { index, updateNotifications, destroy }
